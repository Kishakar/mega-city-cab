							...
							<div class="car-wrap rounded ftco-animate">
								...
								<div class="text">
									...
									<p class="d-flex mb-0 d-block">
										<a href="confirmBooking.jsp?name=BMW X5&brand=BMW&price=600"
						...
						<div class="item">
							<div class="car-wrap rounded ftco-animate">
								...
								<div class="text">
									...
									<p class="d-flex mb-0 d-block">
										<a href="confirmBooking.jsp?name=Audi A6&brand=Audi&price=550"
											class="btn btn-primary py-2 mr-1">Book now</a> <a href="#"
											class="btn btn-secondary py-2 ml-1">Details</a>
									</p>
								</div>
						...
						<div class="item">
							<div class="car-wrap rounded ftco-animate">
								...
								<div class="text">
									...
									<p class="d-flex mb-0 d-block">
										<a
											href="confirmBooking.jsp?name=Tesla Model S&brand=Tesla&price=700"
											class="btn btn-primary py-2 mr-1">Book now</a> <a href="#"
											class="btn btn-secondary py-2 ml-1">Details</a>
									</p>
								</div>
						...
						<div class="item">
							<div class="car-wrap rounded ftco-animate">
								...
								<div class="text">
									...
									<p class="d-flex mb-0 d-block">
										<a
											href="confirmBooking.jsp?name=Range Rover Sport&brand=Land Rover&price=650"
											class="btn btn-primary py-2 mr-1">Book now</a> <a href="#"
											class="btn btn-secondary py-2 ml-1">Details</a>
									</p>
								</div>
